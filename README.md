...
* [Application](Application_2024.07034.CPCA.pdf)
...
* [Application](application_2024_10004_CPCA_A1.pdf)
* [Contract](TA_2024_10004_CPCA_A1.pdf)
...
Entregáveis:  
  ...
  * E2.2 – [Base de dados de referência em formato ESRI shapefile ou Geopackage para uma tile Sentinel-2 sobre Portugal Continental](Entregavel_2_2_BDR_navigator_sentinel2_metadados_v4.pdf) (7 de julho de 2024). A [base de dados BRD_NVG_S2_V01](BRD_NVG_S2_V01.zip) está disponível aqui (exige palavra-passe). 
