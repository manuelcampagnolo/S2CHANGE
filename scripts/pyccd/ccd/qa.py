...
# #             (thermal < max_celsius))
#----------------------------------
# def standard_procedure_filter(observations, dates):
#     if observations.ndim == 1:
#         # Se houver apenas uma dimensão, adiciona uma dimensão para garantir que o código funcione
#         observations = observations.reshape(1, -1)

#     # Cria uma máscara onde as observações são iguais a 65535
#     mask_65535 = (observations == 65535).any(axis=0)

#     # Ajusta a máscara para lidar com duplicatas nas datas
#     unique_dates = np.unique(dates)

#     # Cria a máscara final apenas para as datas únicas
#     final_mask = ~np.isin(dates, unique_dates) | ~mask_65535
...
#     # Cria uma máscara onde as observações são iguais a 65535
#     mask_65535 = (observations == 65535)

#     # Ajusta a máscara para lidar com duplicatas nas datas
#     unique_dates, inverse_indices = np.unique(dates, return_inverse=True)

#     # Cria a máscara final apenas para as datas únicas
#     final_mask = mask_65535[inverse_indices]
